...
import { eventAPICancel, eventAPICreate, eventAPIDelete, eventAPIDetails, eventAPIRange, eventAPIRegister, eventAPIUpdate } from './api_routes/event.js';
...
app.post('/api/event', needsJSON, eventAPIRange);
